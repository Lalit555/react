        ...
        <div className="relative min-h-screen w-full bg-black text-white flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
                {stars.map((star) => (
                    <div
                        key={star.id}
                        className={`absolute ${star.direction === "topLeft"
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
                ...
                <p className="mb-20 text-xl text-gray-300">
                    Oops! Looks like this page got lost in space
                </p>
                <a
                    href="/"
                    className="px-6 py-3 mt-10  text-white bg-purple-600 rounded-lg hover:bg-purple-700 transition-all"
                >
                    Return Home
                </a>
            </div>
